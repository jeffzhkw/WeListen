...
function LiveStream({userInfo}){
    ...
    <div>
        <div class="container-fluid banner">
            ...
            <a class="Header-link " href="https://github.com/AgoraIO/API-Examples-Web/tree/main/Demo">
        ...
        <div class="container">
            ...
            <div class="row join-info-group">
                <div class="col-sm">
                    ...
                    <input id="channel" type="text" placeholder="enter room name" required/>
                </div>
            </div>
            ...
            <div class="button-group">
                ...
                <div class="btn-group">
                <button id="audience-join" type="button" class="btn btn-primary btn-sm">
                    Join as audience
                </button>
                </div>
